...
var Wrapper = _styledComponents2.default.div.withConfig({
  displayName: 'Application__Wrapper'
})(['height:100vh;display:flex;']);

var Sidebar = _styledComponents2.default.div.withConfig({
  displayName: 'Application__Sidebar'
})(['flex:0 1 250px;background:#f4f4f4;']);

var Logo = _styledComponents2.default.div.withConfig({
  displayName: 'Application__Logo'
})(['height:70px;background:#3498DB;display:flex;align-items:center;h1{margin:auto;color:white;text-transform:uppercase;font-size:16px;}']);

var NavigationList = _styledComponents2.default.ul.withConfig({
  displayName: 'Application__NavigationList'
})(['list-style:none;margin:0;padding:0;']);

var NavigationCategory = _styledComponents2.default.li.withConfig({
  displayName: 'Application__NavigationCategory'
})(['display:block;padding:0 32px 4px;padding-top:32px;color:#939da3;font-size:13px;line-height:18px;text-transform:uppercase;font-weight:400;font-family:\'Roboto\',sans-serif;']);

var NavigationEntry = _styledComponents2.default.li.withConfig({
  displayName: 'Application__NavigationEntry'
})(['display:block;color:#555;padding:6px 32px;font-size:12px;font-weight:300;&:hover{text-decoration:underline;cursor:pointer;}']);

var Content = _styledComponents2.default.div.withConfig({
  displayName: 'Application__Content'
})(['padding:16px;flex:1 0 auto;background:#fdfdfd;color:black']);
...
_reactDom2.default.render(_react2.default.createElement(_Application2.default, null), document.querySelector('#root'));
...
*/
var aa=__webpack_require__(2),m=__webpack_require__(10),A=__webpack_require__(4),B=__webpack_require__(1),ca=__webpack_require__(9),da=__webpack_require__(13),ea=__webpack_require__(14),ha=__webpack_require__(11),ia=__webpack_require__(12),C=__webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_is_plain_object__ = __webpack_require__(26);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_is_function__ = __webpack_require__(25);
